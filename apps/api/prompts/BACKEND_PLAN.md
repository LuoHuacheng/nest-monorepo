...
| `event_registration_card` | 赛事报名级别/规格 | id, event_id, name, group_type, spec_name, spec_description, gender_limit, min_age, max_age, price, quota, sold_count, status, sort, created_at                                                                                                                                                                                                                                                                                             |
...
| `event_invite_code`       | 邀请码            | id, event_id, code, max_uses, used_count, status, expires_at, created_at                                                                                                                                                                                                                                                                                                                                                                    |
...
| GET    | `/api/events/:id/orders`       | 赛事参订单。   | event:list   |
...
| `registrationGroups`                                                                        | object[]              | 是   | 报名级别列表                                                     |
