...
async function main() {
  ...
  const permissionCodes = [
    ...
    "registration-card:create",
    "registration-card:update",
    "registration-card:delete",
    "order:list",
    "order:create",
    "order:refund",
    "organizer:list",
    ...
    "organizer:update",
    "organizer:delete",
    "athletic-center:list",
    "athletic-center:create",
    "athletic-center:update",
    "athletic-center:delete",
    "pacer:list",
    "pacer:create",
    "pacer:approve",
    "pacer:suspend",
  ...
  const permissionNames: Record<string, string> = {
    ...
    "event:update": "更新赛事",
    "event:delete": "删除赛事",
    "registration-card:list": "报名卡列表",
    "registration-card:create": "创建报名卡",
    "registration-card:update": "更新报名卡",
    "registration-card:delete": "删除报名卡",
    "order:list": "订单列表",
    "order:create": "创建订单",
    "order:refund": "订单退款",
    "organizer:list": "组委会列表",
    "organizer:create": "创建组委会",
    "organizer:update": "更新组委会",
    "organizer:delete": "删除组委会",
    "athletic-center:list": "田管中心列表",
    "athletic-center:create": "创建田管中心",
    "athletic-center:update": "更新田管中心",
    "athletic-center:delete": "删除田管中心",
    "pacer:list": "配速员列表",
    "pacer:create": "创建配速员",
    "pacer:approve": "审核配速员",
    "pacer:suspend": "暂停配速员",
    ...
    "client-config:list": "配置列表",
    "client-config:update": "更新配置",
  };
  ...
  const menus = [
    ...
    },
    {
      ...
      sort: 4,
      type: "menu",
      permissionCode: "athletic-center:list",
    },
